/**
 * Animated loading icon — morphing shapes with organic gradient blobs.
 *
 * Usage:
 *   import { createLoadingIcon } from './loading-icon.js';
 *
 *   // Append to a container (renders at `size` × `size` px)
 *   const { canvas, destroy } = createLoadingIcon({
 *     container: document.getElementById('loader'),
 *     size: 200,                         // default 200
 *     backgroundColor: '#000',           // default '#000', use 'transparent' for no bg
 *   });
 *
 *   // Later, to stop the animation and clean up:
 *   destroy();
 */
